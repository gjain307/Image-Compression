...
% m2 = m .* quality;
% m1 = double(y.quality) / 100 .* m;      % Get encoding quality.
...
%         y(i1:i1+7,i2:i2+7) = idct2(zBLOCK);
        
        
          for i= 1:c  
               if  t(ceil(i1/a),ceil(i2/b))==i
                   zBLOCK = round(zBLOCK .* (m.*quality(i)));
                break;
               end
          end
